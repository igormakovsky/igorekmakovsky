...
$description_ru = '';
$description_en = '';
$keywords_ru = 'праздник, стихи, ежедневник, мама';
$keywords_en = 'holiday, poems, diary, mother';
...
require $_SERVER['DOCUMENT_ROOT'].'/'.'includes/head.php';?>
    ...
    <section style="margin-top:10rem;">
        ...
        <div class="center">
            <img src="img/holiday-0.jpg" srcset="img/holiday-0@2x.jpg 2x">
        </div>
    ...
    <section style="margin-top:11rem;">
        ...
        <div class="center">
            <img src="img/holiday-1.jpg" srcset="img/holiday-1@2x.jpg 2x">
        </div>
    ...
    <section style="margin-top:12rem;">
        ...
        <div class="center">
            <img src="img/holiday-2.jpg" srcset="img/holiday-2@2x.jpg 2x">
        </div>

    </section>

    <section class="picture" style="margin-top:10rem; width:80%;">

        <div class="center">
            <img src="img/holiday-3.jpg" srcset="img/holiday-3@2x.jpg 2x">
        </div>
    ...
    <section style="margin-top:12rem;">
        ...
        <div class="center">
            <img src="img/holiday-4.jpg" srcset="img/holiday-4@2x.jpg 2x">
        </div>
    ...
    <section style="margin-top:12rem;">
        ...
        <div class="center">
            <img src="img/holiday-5.jpg" srcset="img/holiday-5@2x.jpg 2x">
        </div>
    ...
    <section style="margin-top:12rem;">
        ...
        <div class="center">
            <img src="img/holiday-6.jpg" srcset="img/holiday-6@2x.jpg 2x">
        </div>

    </section>

    <section class="picture" style="margin-top:13rem; width:80%;">

        <div class="center">
            <img src="img/holiday-7.jpg" srcset="img/holiday-7@2x.jpg 2x">
        </div>
    ...
    <section style="margin-top:12rem;">
        ...
        <div class="center">
            <img src="img/holiday-8.jpg" srcset="img/holiday-8@2x.jpg 2x">
        </div>

    </section>

    <section class="picture" style="margin-top:12rem; width:80%;">

        <div class="center">
            <img src="img/holiday-9.jpg" srcset="img/holiday-9@2x.jpg 2x">
        </div>
    ...
    <section style="margin-top:12rem;">
        ...
        <div class="center">
            <img src="img/holiday-10.jpg" srcset="img/holiday-10@2x.jpg 2x">
        </div>
    ...
    <section class="picture" style="margin-top:12rem; width:80%;">
        ...
        <div class="center">
            <img src="img/holiday-12.jpg" srcset="img/holiday-12@2x.jpg 2x">
        </div>
    ...
    <section class="picture" style="margin-top:12rem; width:70%;">

        <div class="center">
            <img src="img/holiday-13.jpg" srcset="img/holiday-13@2x.jpg 2x">
        </div>

    </section>

    <section style="margin:10rem auto 14rem;">

        <div class="center">
            <img src="img/holiday-14.jpg" srcset="img/holiday-14@2x.jpg 2x">
        </div>
